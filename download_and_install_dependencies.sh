...
mkdir $DAGR_DIR/libs
cd $DAGR_DIR/libs
git clone --no-checkout https://github.com/facebookresearch/detectron2.git
cd $DAGR_DIR/libs/detectron2/
git checkout 32bd159d7263683e39bf4e87e5c4ac88bad2fd73

# Download YOLOX
cd $DAGR_DIR/libs
git clone --no-checkout https://github.com/Megvii-BaseDetection/YOLOX.git
